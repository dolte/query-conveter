...
public class bra09_p02_Generated {

    public static String SQLmon_collect_list_SEL3() {
        String    query="";
        query +=" SELECT  (CASE  WHEN  #{fromYrmn}  >=  '201006'   \n";
        query +=" AND  #{fromYrmn}  <  '201206'  THEN  '1'  WHEN  #{fromYrmn}  >=  '201206'  THEN  '2'  ELSE  '3'  END)  AS  YRMN  FROM  DUAL ";
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL3\" parameterType=\"\" resultType=\"\">\n";
    ...
    public static String SQLmon_collect_list_SEL7() {
        String    query="";
        ...
        query +=" AND  ZC.GRAD_GBN(+)  =  ZB.UPSO_GRAD  )  TB  WHERE  TA.BRAN_CD  =  DECODE(#{branCd},  'AL',  TA.BRAN_CD,  #{branCd})   \n";
        query +=" AND  TA.NEW_DAY  IS  NOT  NULL   \n";
        query +=" AND  TA.NEW_DAY  <=  #{toYrmn}||'31'   \n";
        query +=" AND  (TA.CLSBS_YRMN  IS  NULL   \n";
        query +=" OR  NVL(SUBSTR(TA.CLSBS_INS_DAY,1,6),'  ')  >  #{toYrmn})   \n";
        ...
        query +=" SELECT  REPT_DAY  ,  REPT_NUM  ,  REPT_AMT  ,  COMIS  ,  UPSO_CD  FROM  GIBU.TBRA_REPT  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  DISTR_GBN  IS  NULL   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})  UNION  ALL   \n";
        query +=" SELECT  REPT_DAY  ,  REPT_NUM  ,  DISTR_AMT  ,  0  ,  UPSO_CD  FROM  GIBU.TBRA_REPT_UPSO_DISTR  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})  )  AA  ,  GIBU.TBRA_UPSO  BB  ,  (   \n";
        query +=" SELECT  ZA.UPSO_CD,  ZB.MONPRNCFEE,  ZC.GRADNM,  ZB.BSTYP_CD,  ZB.UPSO_GRAD  FROM(   \n";
        query +=" SELECT  A.UPSO_CD,  MAX(A.JOIN_SEQ)  JOIN_SEQ  FROM  GIBU.TBRA_UPSORTAL_INFO  A  ,  GIBU.TBRA_UPSO  B  WHERE  B.BRAN_CD  =  DECODE(#{branCd},  'AL',  B.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.UPSO_CD  =  B.UPSO_CD  GROUP  BY  A.UPSO_CD  )  ZA  ,  GIBU.TBRA_UPSORTAL_INFO  ZB  ,  GIBU.TBRA_BSTYPGRAD  ZC  WHERE  ZB.JOIN_SEQ  =  ZA.JOIN_SEQ   \n";
        query +=" AND  ZB.UPSO_CD  =  ZA.UPSO_CD   \n";
        ...
        query +=" AND  BB.NEW_DAY  <=  #{toYrmn}||'31'   \n";
        ...
        query +=" AND  ZB.UPSO_CD  =  ZA.UPSO_CD   \n";
        query +=" AND  ZC.BSTYP_CD(+)  =  ZB.BSTYP_CD   \n";
        query +=" AND  ZC.GRAD_GBN(+)  =  ZB.UPSO_GRAD  )  CC  WHERE  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.RETURN_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        ...
        query +=" SELECT  COUNT(A.DEMD_NUM)  CNT  ,  SUM(NVL(A.REPT_AMT,0)-NVL(A.ATAX_AMT,0))  AMT  FROM  FIDU.TLEV_USEDEMDREPT  A  WHERE  A.REPT_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.MDM_CD  LIKE  'DA%'   \n";
        query +=" AND  DECODE(#{reptGbn},NULL,'03','03','03','X')  =  '03'  )  )  TA  ,  GIBU.TBRA_BSTYPGRAD  TB  WHERE  TB.BSTYP_CD(+)  =  'z'   \n";
        ...
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL7\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static String SQLmon_collect_list_SEL8() {
        String    query="";
        ...
        query +=" SELECT  REPT_AMT  ,  COMIS  ,  UPSO_CD  ,  REPT_GBN  FROM  GIBU.TBRA_REPT  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  DISTR_GBN  IS  NULL   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})  UNION  ALL   \n";
        query +=" SELECT  DISTR_AMT  ,  0  ,  UPSO_CD  ,  REPT_GBN  FROM  GIBU.TBRA_REPT_UPSO_DISTR  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})  )  AA  ,  GIBU.TBRA_UPSO  BB  ,  FIDU.TENV_CODE  CC  WHERE  AA.UPSO_CD  IS  NOT  NULL   \n";
        query +=" AND  BB.NEW_DAY  IS  NOT  NULL   \n";
        query +=" AND  BB.NEW_DAY  <=  #{toYrmn}||'31'   \n";
        query +=" AND  BB.UPSO_CD  =  AA.UPSO_CD   \n";
        ...
        query +=" SELECT  '03'  REPT_GBN  ,  COUNT(A.DEMD_NUM)  COUNT2  ,  SUM(NVL(A.REPT_AMT,0)  -  NVL(A.ATAX_AMT,0))  AMT2  FROM  FIDU.TLEV_USEDEMDREPT  A  WHERE  A.REPT_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.MDM_CD  LIKE  'DA%'   \n";
        query +=" AND  DECODE(#{reptGbn},NULL,'03','03','03','X')  =  '03'  GROUP  BY  '03'  )  BB  WHERE  AA.HIGH_CD  =  '00141'   \n";
        query +=" AND  AA.CODE_ETC  =  'A'   \n";
        query +=" AND  BB.REPT_GBN  =  AA.CODE_CD  UNION  ALL   \n";
        query +=" SELECT  '협회입금반환'  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  COUNT2  ,  -SUM(RETURN_AMT)  AMT2  FROM  GIBU.TBRA_REPT_RETURN  A  WHERE  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.RETURN_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'  UNION  ALL  --무대공연  입금반환분  협회  입금반환에서  한번  빼고,  무통장입금내역에서는  더해야함   \n";
        query +=" SELECT  '무통장'  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  COUNT2  ,  SUM(RETURN_AMT)  AMT2  FROM  GIBU.TBRA_REPT_RETURN  A  WHERE  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.RETURN_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.UPSO_CD  IS  NULL  )  WHERE  AMT2  <>  0  GROUP  BY  BSTYP_NM  ORDER  BY  1 ";
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL8\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static String SQLmon_collect_list_SEL12() {
        String    query="";
        ...
        query +=" SELECT  REPT_DAY  ,  REPT_NUM  ,  REPT_AMT  ,  COMIS  ,  UPSO_CD  ,  BRAN_CD  FROM  GIBU.TBRA_REPT  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  DISTR_GBN  IS  NULL  UNION  ALL   \n";
        query +=" SELECT  REPT_DAY  ,  REPT_NUM  ,  DISTR_AMT  ,  0  ,  UPSO_CD  ,  BRAN_CD  FROM  GIBU.TBRA_REPT_UPSO_DISTR  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  REPT_GBN  <>  '08'  UNION  ALL   \n";
        query +=" SELECT  A.REPT_DAY  ,  A.REPT_NUM  ,  (CASE  WHEN  MIN(DISTR_SEQ)  OVER(PARTITION  BY  A.REPT_DAY,  A.REPT_NUM,  A.REPT_GBN)  =  DISTR_SEQ  THEN  A.DISTR_AMT  -  NVL(C.COMIS,  0)  ELSE  A.DISTR_AMT  END)  AS  REPT_AMT  ,  0  ,  A.UPSO_CD  ,  A.BRAN_CD  FROM  GIBU.TBRA_REPT_UPSO_DISTR  A  ,  GIBU.TBRA_REPT_VIRTUAL  B  ,  GIBU.TBRA_REPT  C  WHERE  A.MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        ...
        query +=" AND  ZC.BSTYP_CD(+)  =  ZB.BSTYP_CD   \n";
        query +=" AND  ZC.GRAD_GBN(+)  =  ZB.UPSO_GRAD  )  CC  WHERE  AA.UPSO_CD  IS  NOT  NULL   \n";
        query +=" AND  AA.BRAN_CD  =  DECODE(#{branCd},  'AL',  AA.BRAN_CD,  #{branCd})   \n";
        query +=" AND  BB.NEW_DAY  IS  NOT  NULL   \n";
        query +=" AND  BB.NEW_DAY  <=  #{toYrmn}||'31'   \n";
        query +=" AND  BB.UPSO_CD  =  AA.UPSO_CD   \n";
        ...
        query +=" AND  SUBSTR(REPT_DAY,  1,  6)  <  SUBSTR(MAPPING_DAY,  1,  6)  )  AA  ,  GIBU.TBRA_UPSO  BB  ,  (   \n";
        query +=" SELECT  ZA.UPSO_CD,  ZB.MONPRNCFEE,  ZC.GRADNM,  ZB.BSTYP_CD,  ZB.UPSO_GRAD  FROM  (   \n";
        query +=" SELECT  A.UPSO_CD,  MAX(A.JOIN_SEQ)  AS  JOIN_SEQ  FROM  GIBU.TBRA_UPSORTAL_INFO  A  ,  GIBU.TBRA_UPSO  B  WHERE  B.BRAN_CD  =  DECODE(#{branCd},  'AL',  B.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.UPSO_CD  =  B.UPSO_CD  GROUP  BY  A.UPSO_CD  )  ZA  ,  GIBU.TBRA_UPSORTAL_INFO  ZB  ,  GIBU.TBRA_BSTYPGRAD  ZC  WHERE  ZB.JOIN_SEQ  =  ZA.JOIN_SEQ   \n";
        query +=" AND  ZB.UPSO_CD  =  ZA.UPSO_CD   \n";
        query +=" AND  ZC.BSTYP_CD(+)  =  ZB.BSTYP_CD   \n";
        query +=" AND  ZC.GRAD_GBN(+)  =  ZB.UPSO_GRAD  )  CC  WHERE  AA.UPSO_CD  IS  NOT  NULL   \n";
        ...
        query +=" SELECT  COUNT(A.DEMD_NUM)  AS  CNT  ,  SUM(NVL(A.REPT_AMT,0)-NVL(A.ATAX_AMT,0))  AS  AMT  FROM  FIDU.TLEV_USEDEMDREPT  A  WHERE  A.REPT_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.MDM_CD  LIKE  'CC04%'   \n";
        query +=" AND  DECODE(#{reptGbn},NULL,'03','03','03','X')  =  '03'  )  UNION  ALL   \n";
        ...
        query +=" SELECT  REPT_DAY  ,  REPT_NUM  ,  REPT_AMT  ,  COMIS  ,  UPSO_CD  ,  BRAN_CD  ,  MAPPING_DAY  FROM  GIBU.TBRA_REPT  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  DISTR_GBN  IS  NULL  UNION  ALL   \n";
        query +=" SELECT  REPT_DAY  ,  REPT_NUM  ,  DISTR_AMT  ,  0  ,  UPSO_CD  ,  BRAN_CD  ,  MAPPING_DAY  FROM  GIBU.TBRA_REPT_UPSO_DISTR  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  REPT_GBN  <>  '08'  UNION  ALL   \n";
        query +=" SELECT  A.REPT_DAY  ,  A.REPT_NUM  ,  (CASE  WHEN  MIN(DISTR_SEQ)  OVER(PARTITION  BY  A.REPT_DAY,  A.REPT_NUM,  A.REPT_GBN)  =  DISTR_SEQ  THEN  A.DISTR_AMT  -  NVL(C.COMIS,  0)  ELSE  A.DISTR_AMT  END)  AS  REPT_AMT  ,  0  ,  A.UPSO_CD  ,  A.BRAN_CD  ,  A.MAPPING_DAY  FROM  GIBU.TBRA_REPT_UPSO_DISTR  A  ,  GIBU.TBRA_REPT_VIRTUAL  B  ,  GIBU.TBRA_REPT  C  WHERE  A.MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.REPT_DAY  =  B.REPT_DAY   \n";
        query +=" AND  A.REPT_NUM  =  B.REPT_NUM   \n";
        query +=" AND  A.REPT_GBN  =  '08'   \n";
        ...
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL12\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static String SQLmon_collect_list_SEL13() {
        String    query="";
        ...
        query +=" SELECT  REPT_AMT  ,  COMIS  ,  UPSO_CD  ,  REPT_GBN  ,  BRAN_CD  FROM  GIBU.TBRA_REPT  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  DISTR_GBN  IS  NULL  UNION  ALL   \n";
        query +=" SELECT  DISTR_AMT  ,  0  ,  UPSO_CD  ,  REPT_GBN  ,  BRAN_CD  FROM  GIBU.TBRA_REPT_UPSO_DISTR  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  REPT_GBN  =  DECODE(#{reptGbn},  NULL,  REPT_GBN,  #{reptGbn})   \n";
        query +=" AND  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  REPT_GBN  <>  '08'  UNION  ALL   \n";
        query +=" SELECT  (CASE  WHEN  MIN(DISTR_SEQ)  OVER(PARTITION  BY  A.REPT_DAY,  A.REPT_NUM,  A.REPT_GBN)  =  DISTR_SEQ  THEN  A.DISTR_AMT  -  NVL(C.COMIS,  0)  ELSE  A.DISTR_AMT  END)  AS  REPT_AMT  ,  0  ,  A.UPSO_CD  ,  '08'  ,  A.BRAN_CD  FROM  GIBU.TBRA_REPT_UPSO_DISTR  A  ,  GIBU.TBRA_REPT_VIRTUAL  B  ,  GIBU.TBRA_REPT  C  WHERE  A.MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.REPT_DAY  =  B.REPT_DAY   \n";
        query +=" AND  A.REPT_NUM  =  B.REPT_NUM   \n";
        query +=" AND  A.REPT_GBN  =  '08'   \n";
        ...
        query +=" SELECT  '03'  AS  REPT_GBN  ,  COUNT(A.DEMD_NUM)  AS  COUNT2  ,  SUM(NVL(A.REPT_AMT,0)  -  NVL(A.ATAX_AMT,0))  AS  AMT2  FROM  FIDU.TLEV_USEDEMDREPT  A  WHERE  A.REPT_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.MDM_CD  LIKE  'CC04%'   \n";
        query +=" AND  DECODE(#{reptGbn},NULL,'03','03','03','X')  =  '03'  GROUP  BY  '03'  )  BB  WHERE  AA.HIGH_CD  =  '00141'   \n";
        query +=" AND  AA.CODE_ETC  =  'A'   \n";
        query +=" AND  BB.REPT_GBN  =  AA.CODE_CD  UNION  ALL   \n";
        query +=" SELECT  '협회입금반환'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  -SUM(RETURN_AMT)  AS  AMT2  ,  5  AS  SRT  FROM  GIBU.TBRA_REPT_RETURN  A  WHERE  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.RETURN_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'  UNION  ALL   \n";
        query +=" SELECT  '무통장'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  SUM(RETURN_AMT)  AS  AMT2  ,  4  AS  SRT  FROM  GIBU.TBRA_REPT_RETURN  A  WHERE  A.BRAN_CD  =  DECODE(#{branCd},  'AL',  A.BRAN_CD,  #{branCd})   \n";
        query +=" AND  A.RETURN_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        query +=" AND  #{toYrmn}||'31'   \n";
        query +=" AND  A.UPSO_CD  IS  NULL  UNION  ALL   \n";
        query +=" SELECT  '함저협분배'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  -SUM(PROC_AMT)  AS  AMT2  ,  6  AS  SRT  FROM  GIBU.TBRA_DEMD_REPT_BSCON  WHERE  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  BSCON_CD  =  'T0000001'   \n";
        query +=" AND  MAPPING_YRMN  BETWEEN  #{fromYrmn}   \n";
        query +=" AND  #{toYrmn}  UNION  ALL   \n";
        query +=" SELECT  '함저협입금반환'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  SUM(PROC_AMT)  AS  AMT2  ,  7  AS  SRT  FROM  GIBU.TBRA_BSCON_RETURN  WHERE  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  BSCON_CD  =  'T0000001'   \n";
        query +=" AND  RETURN_YRMN  BETWEEN  #{fromYrmn}   \n";
        query +=" AND  #{toYrmn}  UNION  ALL   \n";
        query +=" SELECT  '음실련분배'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  -SUM(PROC_AMT)  AS  AMT2  ,  8  AS  SRT  FROM  GIBU.TBRA_DEMD_REPT_BSCON  WHERE  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  BSCON_CD  =  'T0000002'   \n";
        query +=" AND  MAPPING_YRMN  BETWEEN  #{fromYrmn}   \n";
        query +=" AND  #{toYrmn}  UNION  ALL   \n";
        query +=" SELECT  '음실련입금반환'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  SUM(PROC_AMT)  AS  AMT2  ,  9  AS  SRT  FROM  GIBU.TBRA_BSCON_RETURN  WHERE  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  BSCON_CD  =  'T0000002'   \n";
        query +=" AND  RETURN_YRMN  BETWEEN  #{fromYrmn}   \n";
        query +=" AND  #{toYrmn}  UNION  ALL   \n";
        query +=" SELECT  '음산협분배'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  -SUM(PROC_AMT)  AS  AMT2  ,  10  AS  SRT  FROM  GIBU.TBRA_DEMD_REPT_BSCON  WHERE  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  BSCON_CD  =  'T0000003'   \n";
        query +=" AND  MAPPING_YRMN  BETWEEN  #{fromYrmn}   \n";
        query +=" AND  #{toYrmn}  UNION  ALL   \n";
        query +=" SELECT  '음산협입금반환'  AS  BSTYP_NM  ,  COUNT(DISTINCT  UPSO_CD)  AS  COUNT2  ,  SUM(PROC_AMT)  AS  AMT2  ,  11  AS  SRT  FROM  GIBU.TBRA_BSCON_RETURN  WHERE  BRAN_CD  =  DECODE(#{branCd},  'AL',  BRAN_CD,  #{branCd})   \n";
        query +=" AND  BSCON_CD  =  'T0000003'   \n";
        query +=" AND  RETURN_YRMN  BETWEEN  #{fromYrmn}   \n";
        query +=" AND  #{toYrmn}  )  WHERE  AMT2  <>  0  GROUP  BY  BSTYP_NM  ORDER  BY  BSTYP_NM ";
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL13\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static String SQLmon_collect_list_SEL5() {
        String    query="";
        query +=" SELECT  BSTYP_NM  ,  MNG_CNT  ,  TOT_AMT  ,  COL_UPSO  ,  COL_AMT  ,  MAP_UPSO  ,  MAP_AMT  FROM(   \n";
        ...
        query +=" AND  COL_UPSO  IS  NOT  NULL  ORDER  BY  MNG_CNT  DESC ";
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL5\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static String SQLmon_collect_list_SEL6() {
        String    query="";
        query +=" SELECT  BSTYP_NM  ,  SUM(COUNT2)  COL_UPSO  ,  SUM(AMT2)  COL_AMT  ,  0  MAP_UPSO  ,  0  MAP_AMT  FROM  (   \n";
        query +=" SELECT  CC.CODE_NM  BSTYP_NM  ,  COUNT(DISTINCT  AA.UPSO_CD)  COUNT2  ,  SUM(NVL(AA.REPT_AMT,0))  -  SUM(NVL(AA.COMIS,0))  AMT2  FROM  (   \n";
        query +=" SELECT  REPT_AMT  ,  COMIS  ,  UPSO_CD  ,  REPT_GBN  FROM  GIBU.TBRA_REPT  WHERE  MAPPING_DAY  BETWEEN  #{fromYrmn}||'01'   \n";
        ...
        String xml ="";
            xml += "<select id=\"SQLmon_collect_list_SEL6\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static String SQLstomu_list_SEL1() {
        String    query="";
        ...
        query +=" AND  AA.MAPPING_DAY  BETWEEN  DD.START_DATE   \n";
        query +=" AND  DD.END_DATE   \n";
        query +=" AND  GIBU.FT_GET_BSTYP_NM(CC.BSTYP_CD)  =  #{bstypNm}  GROUP  BY  DD.BSCON_CD)  AAA  RIGHT  OUTER  JOIN   \n";
        query +=" (SELECT  BSCON_CD,  BSCONHAN_NM,  USE_YN  FROM  GIBU.TBRA_BSCON_STOMU  WHERE  USE_YN  =  'Y'   \n";
        ...
        String xml ="";
            xml += "<select id=\"SQLstomu_list_SEL1\" parameterType=\"\" resultType=\"\">\n";
        xml += SqlFormatter.format(query, FormatConfig.builder().indent("\t").build());
            xml += "\n</select>\n" ;
    ...
    public static void main(String[] args) {
        ...
        String content = top + "\n";    
        content += SQLmon_collect_list_SEL3() + "\n";
        content += SQLmon_collect_list_SEL7() + "\n";
        content += SQLmon_collect_list_SEL8() + "\n";
        content += SQLmon_collect_list_SEL12() + "\n";
        content += SQLmon_collect_list_SEL13() + "\n";
        content += SQLmon_collect_list_SEL5() + "\n";
        content += SQLmon_collect_list_SEL6() + "\n";
        content += SQLstomu_list_SEL1() + "\n";
        content += bottom;

        try {
            String fileName = "bra01_s01_1.xml";
            FileWriter fw = new FileWriter(dir + "bra09_p02.xml");
