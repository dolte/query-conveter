...
public class tac10_r01
{
    ...
    * 수정내용 :
    */
    public DOBJ CTLtac10_r01_dt_select(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLtac10_r01_dt_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(디테일)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLtac10_r01_dt_select( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 년단위 매체별 지급내역(디테일)
    public DOBJ CALLtac10_r01_dt_select_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        SQLObject  sobj = SQLtac10_r01_dt_select_SEL1(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL1");
        dobj.setRetObject(rvobj);
        return dobj;
    }
    private SQLObject SQLtac10_r01_dt_select_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        String    query="";
        query +=" SELECT  RW,  DISTR_YRMN,  SUM(DISTR_AMT1)  DISTR_AMT1,  SUM(DISTR_AMT2)  DISTR_AMT2,  SUM(DISTR_AMT3)  DISTR_AMT3,  SUM(DISTR_AMT4)  DISTR_AMT4,  SUM(DISTR_AMT5)  DISTR_AMT5,  SUM(DISTR_AMT6)  DISTR_AMT6,  SUM(DISTR_AMT7)  DISTR_AMT7,  SUM(DISTR_AMT8)  DISTR_AMT8,  SUM(DISTR_AMT9)  DISTR_AMT9,  (   \n";
        query +=" SELECT  SUM(ORGDISTR_AMT)  FROM  FIDU.TTAC_MDMCLASSSUPPAMT  A,  FIDU.TENV_AVECLASSCD  B  WHERE  SUBSTR(A.MDM_CD,1,2)  =  B.AVECLASS_CD   \n";
        query +=" AND  SUBSTR(A.SUPP_YRMN,1,4)  =  X.DISTR_YRMN   \n";
        query +=" AND  A.MB_CD  =  :MB_CD   \n";
        query +=" AND  A.TRNSF_GBN  LIKE  :TRNSF_GBN  ||  '%'  )  DISTR_AMT10  FROM  (   \n";
        query +=" SELECT  '1'  AS  RW,  SUBSTR(A.SUPP_YRMN,1,4)  DISTR_YRMN,  SUBSTR(A.MDM_CD,1,2)  MDM_CD,  DECODE(B.PRNT_SEQ,  '1',  SUM(A.ORGDISTR_AMT))  DISTR_AMT1,  DECODE(B.PRNT_SEQ,  '4',  SUM(A.ORGDISTR_AMT))  DISTR_AMT2,  DECODE(B.PRNT_SEQ,  '7',  SUM(A.ORGDISTR_AMT))  DISTR_AMT3,  DECODE(B.PRNT_SEQ,  '10',  SUM(A.ORGDISTR_AMT))  DISTR_AMT4,  DECODE(B.PRNT_SEQ,  '13',  SUM(A.ORGDISTR_AMT))  DISTR_AMT5,  DECODE(B.PRNT_SEQ,  '16',  SUM(A.ORGDISTR_AMT))  DISTR_AMT6,  DECODE(B.PRNT_SEQ,  '19',  SUM(A.ORGDISTR_AMT))  DISTR_AMT7,  DECODE(B.PRNT_SEQ,  '22',  SUM(A.ORGDISTR_AMT))  DISTR_AMT8,  DECODE(B.PRNT_SEQ,  '25',  SUM(A.ORGDISTR_AMT))  DISTR_AMT9,  0  AS  DISTR_AMT10  FROM  FIDU.TTAC_MDMCLASSSUPPAMT  A,  FIDU.TENV_AVECLASSCD  B  WHERE  SUBSTR(A.MDM_CD,1,2)  =  B.AVECLASS_CD   \n";
        query +=" AND  SUBSTR(A.SUPP_YRMN,1,4)  BETWEEN  SUBSTR(:FROMDATE,1,4)   \n";
        query +=" AND  SUBSTR(:TODATE,1,4)   \n";
        query +=" AND  A.MB_CD  =  :MB_CD   \n";
        query +=" AND  A.TRNSF_GBN  LIKE  :TRNSF_GBN  ||  '%'  GROUP  BY  SUBSTR(A.SUPP_YRMN,1,4),  SUBSTR(A.MDM_CD,1,2),  B.PRNT_SEQ  UNION  ALL   \n";
        query +=" SELECT  '2'  AS  RW,  SUBSTR(A.SUPP_YRMN,1,4)  DISTR_YRMN,  SUBSTR(A.MDM_CD,1,2)  MDM_CD,  DECODE(B.PRNT_SEQ,  '2',  SUM(A.ORGDISTR_AMT))  DISTR_AMT1,  DECODE(B.PRNT_SEQ,  '5',  SUM(A.ORGDISTR_AMT))  DISTR_AMT2,  DECODE(B.PRNT_SEQ,  '8',  SUM(A.ORGDISTR_AMT))  DISTR_AMT3,  DECODE(B.PRNT_SEQ,  '11',  SUM(A.ORGDISTR_AMT))  DISTR_AMT4,  DECODE(B.PRNT_SEQ,  '14',  SUM(A.ORGDISTR_AMT))  DISTR_AMT5,  DECODE(B.PRNT_SEQ,  '17',  SUM(A.ORGDISTR_AMT))  DISTR_AMT6,  DECODE(B.PRNT_SEQ,  '20',  SUM(A.ORGDISTR_AMT))  DISTR_AMT7,  DECODE(B.PRNT_SEQ,  '23',  SUM(A.ORGDISTR_AMT))  DISTR_AMT8,  DECODE(B.PRNT_SEQ,  '26',  SUM(A.ORGDISTR_AMT))  DISTR_AMT9,  0  AS  DISTR_AMT10  FROM  FIDU.TTAC_MDMCLASSSUPPAMT  A,  FIDU.TENV_AVECLASSCD  B  WHERE  SUBSTR(A.MDM_CD,1,2)  =  B.AVECLASS_CD   \n";
        query +=" AND  SUBSTR(A.SUPP_YRMN,1,4)  BETWEEN  SUBSTR(:FROMDATE,1,4)   \n";
        query +=" AND  SUBSTR(:TODATE,1,4)   \n";
        query +=" AND  A.MB_CD  =  :MB_CD   \n";
        query +=" AND  A.TRNSF_GBN  LIKE  :TRNSF_GBN  ||  '%'  GROUP  BY  SUBSTR(A.SUPP_YRMN,1,4),  SUBSTR(A.MDM_CD,1,2),  B.PRNT_SEQ  UNION  ALL   \n";
        query +=" SELECT  '3'  AS  RW,  SUBSTR(A.SUPP_YRMN,1,4)  DISTR_YRMN,  SUBSTR(A.MDM_CD,1,2)  MDM_CD,  DECODE(B.PRNT_SEQ,  '3',  SUM(A.ORGDISTR_AMT))  DISTR_AMT1,  DECODE(B.PRNT_SEQ,  '6',  SUM(A.ORGDISTR_AMT))  DISTR_AMT2,  DECODE(B.PRNT_SEQ,  '9',  SUM(A.ORGDISTR_AMT))  DISTR_AMT3,  DECODE(B.PRNT_SEQ,  '12',  SUM(A.ORGDISTR_AMT))  DISTR_AMT4,  DECODE(B.PRNT_SEQ,  '15',  SUM(A.ORGDISTR_AMT))  DISTR_AMT5,  DECODE(B.PRNT_SEQ,  '18',  SUM(A.ORGDISTR_AMT))  DISTR_AMT6,  DECODE(B.PRNT_SEQ,  '21',  SUM(A.ORGDISTR_AMT))  DISTR_AMT7,  DECODE(B.PRNT_SEQ,  '24',  SUM(A.ORGDISTR_AMT))  DISTR_AMT8,  DECODE(B.PRNT_SEQ,  '27',  SUM(A.ORGDISTR_AMT))  DISTR_AMT9,  0  AS  DISTR_AMT10  FROM  FIDU.TTAC_MDMCLASSSUPPAMT  A,  FIDU.TENV_AVECLASSCD  B  WHERE  SUBSTR(A.MDM_CD,1,2)  =  B.AVECLASS_CD   \n";
        query +=" AND  SUBSTR(A.SUPP_YRMN,1,4)  BETWEEN  SUBSTR(:FROMDATE,1,4)   \n";
        query +=" AND  SUBSTR(:TODATE,1,4)   \n";
        query +=" AND  A.MB_CD  =  :MB_CD   \n";
        query +=" AND  A.TRNSF_GBN  LIKE  :TRNSF_GBN  ||  '%'  GROUP  BY  SUBSTR(A.SUPP_YRMN,1,4),  SUBSTR(A.MDM_CD,1,2),  B.PRNT_SEQ  )X  GROUP  BY  DISTR_YRMN,  RW  ORDER  BY  DISTR_YRMN ";
        sobj.setSql(query);
    ...
    * 수정내용 :
    */
    public DOBJ CTLtac10_r01_prt_select(DOBJ dobj)
    {
        WizUtil wutil = new WizUtil(dobj);
        Connection Conn = null;
        try
        ...
        try
        {
            dobj  = CALLtac10_r01_prt_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(출력)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLtac10_r01_prt_select( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        Connection Conn = (Connection)Connx;
        dobj  = CALLtac10_r01_prt_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(출력)
    ...
    // 년단위 매체별 지급내역(출력)
    public DOBJ CALLtac10_r01_prt_select_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        dobj.setRtnname("SEL1");
        QExecutor qexe = new QExecutor(dobj);
        dobj.setRtnname("SEL1");
        VOBJ dvobj = dobj.getRetObject("S");           //사용자 화면에서 발생한 Object입니다.
        SQLObject  sobj = SQLtac10_r01_prt_select_SEL1(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL1");
        dobj.setRetObject(rvobj);
        return dobj;
    }
    private SQLObject SQLtac10_r01_prt_select_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        String   MB_CD = dobj.getRetObject("S").getRecord().get("MB_CD");   //회원 코드
        String   TODATE = dobj.getRetObject("S").getRecord().get("TODATE");   //종료일자
    ...
    * 수정내용 :
    */
    public DOBJ CTLtac10_r01_sum_select(DOBJ dobj)
    {
        WizUtil wutil = new WizUtil(dobj);
        Connection Conn = null;
        try
        ...
        try
        {
            dobj  = CALLtac10_r01_sum_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(합계)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLtac10_r01_sum_select( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        Connection Conn = (Connection)Connx;
        dobj  = CALLtac10_r01_sum_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(합계)
    ...
    // 년단위 매체별 지급내역(합계)
    public DOBJ CALLtac10_r01_sum_select_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        dobj.setRtnname("SEL1");
        QExecutor qexe = new QExecutor(dobj);
        dobj.setRtnname("SEL1");
        VOBJ dvobj = dobj.getRetObject("S");           //사용자 화면에서 발생한 Object입니다.
        SQLObject  sobj = SQLtac10_r01_sum_select_SEL1(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL1");
        dobj.setRetObject(rvobj);
        return dobj;
    }
    private SQLObject SQLtac10_r01_sum_select_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        String   MB_CD = dobj.getRetObject("S").getRecord().get("MB_CD");   //회원 코드
        String   TODATE = dobj.getRetObject("S").getRecord().get("TODATE");   //종료일자
    ...
    * 수정내용 :
    */
    public DOBJ CTLtac10_r01_hd_select(DOBJ dobj)
    {
        WizUtil wutil = new WizUtil(dobj);
        Connection Conn = null;
        try
        ...
        try
        {
            dobj  = CALLtac10_r01_hd_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(헤더)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLtac10_r01_hd_select( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        Connection Conn = (Connection)Connx;
        dobj  = CALLtac10_r01_hd_select_SEL1(Conn, dobj);           //  년단위 매체별 지급내역(헤더)
    ...
    // 년단위 매체별 지급내역(헤더)
    public DOBJ CALLtac10_r01_hd_select_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        dobj.setRtnname("SEL1");
        QExecutor qexe = new QExecutor(dobj);
        dobj.setRtnname("SEL1");
        VOBJ dvobj = dobj.getRetObject("S");           //사용자 화면에서 발생한 Object입니다.
        SQLObject  sobj = SQLtac10_r01_hd_select_SEL1(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL1");
        rvobj.setRetcode(1);
        dobj.setRetObject(rvobj);
    ...
    private SQLObject SQLtac10_r01_hd_select_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        SQLObject sobj = new SQLObject();
        String    query="";
