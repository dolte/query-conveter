...
public class tac10_r26
{
    ...
    */
    public DOBJ CTLtac10_r26_dt_select(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLtac10_r26_dt_select_SEL1(Conn, dobj);           //  미지급해제내역서(디테일)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    */
    public DOBJ CTLtac10_r26_prt_select(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLtac10_r26_prt_select_SEL1(Conn, dobj);           //  미지급해제내역서(출력)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    */
    public DOBJ CTLtac10_r26_sum_select(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLtac10_r26_sum_select_SEL1(Conn, dobj);           //  미지급해제내역서(합계)
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    {
        WizUtil wutil = new WizUtil(dobj);
        String   MB_CD = dobj.getRetObject("S").getRecord().get("PROD_CD");   //회원 코드
        String   PROD_CD = dobj.getRetObject("S").getRecord().get("PROD_CD");   //작품 코드
        String   SUPP_YRMN = dobj.getRetObject("S").getRecord().get("SUPP_YRMN");   //지급 년월
        SQLObject sobj = new SQLObject();
        String    query="";
    ...
    */
    public DOBJ CTLtac10_r26_hd_select(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLtac10_r26_hd_select_SEL1(Conn, dobj);           //  매체별미지급금 내역(헤더)
        }
        catch(Exception e)
        {
            e.printStackTrace();
