...
public class bra09_p05_1
{
    ...
    */
    ...
    private SQLObject SQLnonpy_upso_cnt_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        ...
        query +=" AND  GIBU.FT_SPLIT(XA.DEMDS,  ',',  2)  =  DECODE(:BSTYP_CD,  NULL,  GIBU.FT_SPLIT(XA.DEMDS,  ',',  2),  :BSTYP_CD)  )  group  by  ATTE,  CITYCNTYDSRC  ORDER  BY  ATTE,  CITYCNTYDSRC ";
        sobj.setSql(query);
