...
import WIZ.FR.MSG.*;
import WIZ.FR.UTIL.*;
public class bra01_s18_5
{
    public bra01_s18_5()
    {
    }
    //##**$$search_prod_upso_test
    /*
    */
    public DOBJ CTLsearch_prod_upso_test(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLsearch_prod_upso_test_SEL1(Conn, dobj);           //  조회
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLsearch_prod_upso_test( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 조회
    public DOBJ CALLsearch_prod_upso_test_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        SQLObject  sobj = SQLsearch_prod_upso_test_SEL1(dobj, dvobj);
    ...
    private SQLObject SQLsearch_prod_upso_test_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
