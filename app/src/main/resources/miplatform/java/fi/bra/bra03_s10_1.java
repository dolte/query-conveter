...
public class bra03_s10_1
{
    ...
    */
    ...
    private SQLObject SQLindtnpaper_list_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        ...
        query +=" AND  XA.INSPRES_ID  <>  'DEMD_MICR_REPT'  ORDER  BY  DEMD_DAY,  DEMD_NUM ";
        sobj.setSql(query);
