...
import WIZ.FR.MSG.*;
import WIZ.FR.UTIL.*;
public class bra01_s18_bak
{
    public bra01_s18_bak()
    {
    }
    //##**$$search_prod_upso_bak
    /*
    */
    public DOBJ CTLsearch_prod_upso_bak(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLsearch_prod_upso_bak_SEL1(Conn, dobj);           //  조회
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLsearch_prod_upso_bak( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 조회
    public DOBJ CALLsearch_prod_upso_bak_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        SQLObject  sobj = SQLsearch_prod_upso_bak_SEL1(dobj, dvobj);
    ...
    private SQLObject SQLsearch_prod_upso_bak_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        query +=" FROM (  ";
        query +=" SELECT SONG_ID , UPSO_CD, BRAN_CD , COUNT(*) AS CNT , (SELECT *+ INDEX_DESC (KDS_SHOPROOM PK_KDS_SM_SEQ) * BSCON_CD  ";
