...
public class bra04_r18
{
    ...
    */
    ...
    private SQLObject SQLrept_return_list_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        ...
        String    query="";
        query +=" SELECT  XA.RETURN_DAY  ,  XA.RETURN_NUM  ,  XA.UPSO_CD  ,  XB.UPSO_NM  ,  XB.MNGEMSTR_NM  ,  XC.GRADNM  ,  XC.MONPRNCFEE  ,  XA.RETURN_AMT  ,  XA.REMAK  ,  XD.HAN_NM  STAFF_NM  ,  XC.BSTYP_CD  ,  XB.BRAN_CD  FROM  GIBU.TBRA_REPT_RETURN  XA  ,  GIBU.TBRA_UPSO  XB  ,  (   \n";
