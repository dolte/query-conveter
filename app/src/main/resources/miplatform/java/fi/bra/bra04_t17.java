...
public class bra04_t17
{
    ...
    */
    ...
    private SQLObject SQLmisu_select_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        ...
        String    query="";
        query +=" SELECT A.NONPY_DAY , A.BRAN_CD , FIDU.GET_GIBU_NM(A.BRAN_CD) AS BRAN_NM , A.UPSO_CD , B.UPSO_NM , B.STAFF_CD , FIDU.GET_STAFF_NM(B.STAFF_CD) AS STAFF_NM , A.BEFORE_NONPY_AMT , A.DEMD_AMT , A.REPT_AMT , A.ADJ_AMT , A.NONPY_AMT , TO_CHAR(A.INS_DATE, 'YYYYMMDD') AS INS_DATE , A.DEMD_MMCNT  ";
        query +=" FROM GIBU.TBRA_MISU_CHEKWON A , GIBU.TBRA_UPSO B  ";
