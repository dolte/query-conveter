...
public class bra01_s18_4
{
    ...
    /*
    */
    public DOBJ CTLsearch_prod_upso_4(DOBJ dobj)
    {
        ...
        try
        {
            dobj  = CALLsearch_prod_upso_4_SEL1(Conn, dobj);           //  조회
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public DOBJ CTLsearch_prod_upso_4( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 조회
    public DOBJ CALLsearch_prod_upso_4_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        SQLObject  sobj = SQLsearch_prod_upso_4_SEL1(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL1");
        dobj.setRetObject(rvobj);
        return dobj;
    }
    private SQLObject SQLsearch_prod_upso_4_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        query +=" FROM GIBU.TBRA_UPSO  ";
        query +=" WHERE UPSO_CD = X.UPSO_CD) AS STAFF_CD  ";
        query +=" FROM (  ";
