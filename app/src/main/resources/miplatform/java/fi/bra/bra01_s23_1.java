...
public class bra01_s23_1
{
    ...
    */
    ...
    private SQLObject SQLget_diff_bscon_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        ...
        query +=" AND  ROWNUM  =  1)  AS  BSCON_CD_SHOPROOM  FROM  LOG.KDS_STATISTICS  A  WHERE  TO_CHAR(PLAY_SDATE,  'YYYYMMDD')  BETWEEN  :START_YRMN   \n";
        query +=" AND  :END_YRMN   \n";
        ...
        query +=" SELECT  SERIAL_NO,  PLAY_SDATE,  UPSO_CD,  BRAN_CD,  BSCON_CD,  FIX_DATE  ,  BSCON_CD_SHOPROOM  FROM  LOG.KDS_STATISTICS_DEL  A  WHERE  TO_CHAR(PLAY_SDATE,  'YYYYMMDD')  BETWEEN  :START_YRMN   \n";
        query +=" AND  :END_YRMN   \n";
