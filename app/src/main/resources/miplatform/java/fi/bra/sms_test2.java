...
public class sms_test2
{
    ...
    */
    ...
    public DOBJ CALLsms_test_MIUD3(Connection Conn, DOBJ dobj) throws Exception
    {
        ...
        while(dvobj.next())
        {
            if(dvobj.getRecord().get("IUDFLAG").equals("I"))
            {
                ...
                dobj  = CALLsms_test_XIUD2(Conn, dobj);           //  발송테이블 저장
                dobj  = CALLsms_test_XIUD14(Conn, dobj);           //  커밋
            }
        }
        return dobj;
    }
    ...
    // 발송테이블 저장
    public DOBJ CALLsms_test_XIUD2(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        QExecutor qexe = new QExecutor(dobj);
        ...
        while(dvobj.next())
        {
            sobj = SQLsms_test_XIUD2(dobj, dvobj);
    ...
    private SQLObject SQLsms_test_XIUD2(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 커밋
    public DOBJ CALLsms_test_XIUD14(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        QExecutor qexe = new QExecutor(dobj);
        ...
        while(dvobj.next())
        {
            sobj = SQLsms_test_XIUD14(dobj, dvobj);
            updcnt += qexe.executeUpdate(Conn, sobj);
        }
        rvobj = new VOBJ();
        HashMap recordx = new HashMap();
    ...
    private SQLObject SQLsms_test_XIUD14(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        SQLObject sobj = new SQLObject();
        String    query="";
