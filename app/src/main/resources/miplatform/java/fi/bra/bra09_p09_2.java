...
import WIZ.FR.MSG.*;
import WIZ.FR.UTIL.*;
public class bra09_p09_2
{
    public bra09_p09_2()
    {
    }
    //##**$$staff_collect_list_test2
    /*
    */
    public DOBJ CTLstaff_collect_list_test2(DOBJ dobj)
    {
        ...
        try
        {
            ...
            {
                dobj  = CALLstaff_collect_list_test2_SEL1(Conn, dobj);           //  지역담당자징수현황(관리)
                dobj  = CALLstaff_collect_list_test2_MRG1( dobj);        //  리스트항목결과취합
            }
            else if( dobj.getRetObject("S").getRecord().get("GBN").equals("2"))
            {
                dobj  = CALLstaff_collect_list_test2_SEL6(Conn, dobj);           //  지역담당자징수현황(개발)
                dobj  = CALLstaff_collect_list_test2_MRG1( dobj);        //  리스트항목결과취합
            }
            else
            {
                dobj  = CALLstaff_collect_list_test2_SEL8(Conn, dobj);           //  지역담당자징수현황(전체)
                dobj  = CALLstaff_collect_list_test2_MRG1( dobj);        //  리스트항목결과취합
            }
        }
        catch(Exception e)
    ...
    public DOBJ CTLstaff_collect_list_test2( DOBJ dobj, Object Connx) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 지역담당자징수현황(관리)
    public DOBJ CALLstaff_collect_list_test2_SEL1(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        SQLObject  sobj = SQLstaff_collect_list_test2_SEL1(dobj, dvobj);
    ...
    private SQLObject SQLstaff_collect_list_test2_SEL1(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
    ...
    // 리스트항목결과취합
    public DOBJ CALLstaff_collect_list_test2_MRG1(DOBJ dobj) throws Exception
    {
    ...
    // 지역담당자징수현황(개발)
    public DOBJ CALLstaff_collect_list_test2_SEL6(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        dobj.setRtnname("SEL6");
        VOBJ dvobj = dobj.getRetObject("S");           //사용자 화면에서 발생한 Object입니다.
        SQLObject  sobj = SQLstaff_collect_list_test2_SEL6(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL6");
        dobj.setRetObject(rvobj);
        return dobj;
    }
    private SQLObject SQLstaff_collect_list_test2_SEL6(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        String   YRMN = dobj.getRetObject("S").getRecord().get("YRMN");   //년월
        String   BRAN_CD = dobj.getRetObject("S").getRecord().get("BRAN_CD");   //지부 코드
    ...
    // 지역담당자징수현황(전체)
    public DOBJ CALLstaff_collect_list_test2_SEL8(Connection Conn, DOBJ dobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        ...
        dobj.setRtnname("SEL8");
        VOBJ dvobj = dobj.getRetObject("S");           //사용자 화면에서 발생한 Object입니다.
        SQLObject  sobj = SQLstaff_collect_list_test2_SEL8(dobj, dvobj);
        VOBJ rvobj = qexe.executeQuery(Conn, sobj);
        rvobj.setName("SEL8");
        dobj.setRetObject(rvobj);
        return dobj;
    }
    private SQLObject SQLstaff_collect_list_test2_SEL8(DOBJ dobj, VOBJ dvobj) throws Exception
    {
        WizUtil wutil = new WizUtil(dobj);
        String   YRMN = dobj.getRetObject("S").getRecord().get("YRMN");   //년월
        String   BRAN_CD = dobj.getRetObject("S").getRecord().get("BRAN_CD");   //지부 코드
